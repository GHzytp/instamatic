...
FEI_EXE = 'C:\\JEOL\\TOOL\\GonioTool.exe'

HOST = config.settings.fei_exe_server_host
PORT = config.settings.fei_exe_server_host
BUFSIZE = 1024
...
class FEIGUIControlWrapper:
    """Interfaces with Goniotool to automate the free lens control, aperture insertion...
    ...
    def __init__(self, barrier=None):
        ...
        self.app = Application().connect(FEI_EXE)
        self.startup()
