# Functions for generating virtual images. Adapted from py4DSTEM: https://github.com/pyFourDSTEM/pyFourDSTEM
...
def get_virtualimage_rect(datacube, xmin, xmax, ymin, ymax):
    ...
    virtual_image = np.sum(datacube[:,:,xmin:xmax,ymin:ymax], axis=(2,3))
