...
class HolderGUI(LabelFrame):
    ...
    def __init__(self, parent):
        ...
        vcmd = (self.parent.register(self.validate),
                '%d', '%i', '%P', '%s', '%S', '%v', '%V', '%W')
        self.coff_0 = Entry(frame, textvariable=self.var_coff_0, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_0.focus()
        self.coff_0.grid(row=1, column=3, sticky='EW', padx=5)
        Hoverbox(self.coff_0, 'Compensation Coefficient 0')
        self.coff_1 = Entry(frame, textvariable=self.var_coff_1, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_1.focus()
        self.coff_1.grid(row=1, column=4, sticky='EW')
        Hoverbox(self.coff_1, 'Compensation Coefficient 1')
        self.coff_2 = Entry(frame, textvariable=self.var_coff_2, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_2.focus()
        self.coff_2.grid(row=1, column=5, sticky='EW', padx=5)
        Hoverbox(self.coff_2, 'Compensation Coefficient 2')
        self.coff_3 = Entry(frame, textvariable=self.var_coff_3, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_3.focus()
        self.coff_3.grid(row=1, column=6, sticky='EW')
        Hoverbox(self.coff_3, 'Compensation Coefficient 3')
        self.coff_4 = Entry(frame, textvariable=self.var_coff_4, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_4.focus()
        self.coff_4.grid(row=1, column=7, sticky='EW', padx=5)
        Hoverbox(self.coff_4, 'Compensation Coefficient 4')
        self.coff_5 = Entry(frame, textvariable=self.var_coff_5, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_5.focus()
        self.coff_5.grid(row=1, column=8, sticky='EW')
        Hoverbox(self.coff_5, 'Compensation Coefficient 5')

        self.coff_6 = Entry(frame, textvariable=self.var_coff_6, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_6.focus()
        self.coff_6.grid(row=2, column=0, sticky='EW')
        Hoverbox(self.coff_6, 'Compensation Coefficient 6')
        self.coff_7 = Entry(frame, textvariable=self.var_coff_7, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_7.focus()
        self.coff_7.grid(row=2, column=1, sticky='EW', padx=5)
        Hoverbox(self.coff_7, 'Compensation Coefficient 7')
        self.coff_8 = Entry(frame, textvariable=self.var_coff_8, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_8.focus()
        self.coff_8.grid(row=2, column=2, sticky='EW')
        Hoverbox(self.coff_8, 'Compensation Coefficient 8')
        self.coff_9 = Entry(frame, textvariable=self.var_coff_9, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_9.focus()
        self.coff_9.grid(row=2, column=3, sticky='EW', padx=5)
        Hoverbox(self.coff_9, 'Compensation Coefficient 9')
        self.coff_10 = Entry(frame, textvariable=self.var_coff_10, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_10.focus()
        self.coff_10.grid(row=2, column=4, sticky='EW')
        Hoverbox(self.coff_10, 'Compensation Coefficient 10')
        self.coff_11 = Entry(frame, textvariable=self.var_coff_11, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_11.focus()
        self.coff_11.grid(row=2, column=5, sticky='EW', padx=5)
        Hoverbox(self.coff_11, 'Compensation Coefficient 11')
        self.coff_12 = Entry(frame, textvariable=self.var_coff_12, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_12.focus()
        self.coff_12.grid(row=2, column=6, sticky='EW')
        Hoverbox(self.coff_12, 'Compensation Coefficient 12')
        self.coff_13 = Entry(frame, textvariable=self.var_coff_13, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_13.focus()
        self.coff_13.grid(row=2, column=7, sticky='EW', padx=5)
        Hoverbox(self.coff_13, 'Compensation Coefficient 13')
        self.coff_14 = Entry(frame, textvariable=self.var_coff_14, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_14.focus()
        self.coff_14.grid(row=2, column=8, sticky='EW')
        Hoverbox(self.coff_14, 'Compensation Coefficient 14')

        self.coff_15 = Entry(frame, textvariable=self.var_coff_15, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_15.focus()
        self.coff_15.grid(row=3, column=0, sticky='EW')
        Hoverbox(self.coff_15, 'Compensation Coefficient 15')
        self.coff_16 = Entry(frame, textvariable=self.var_coff_16, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_16.focus()
        self.coff_16.grid(row=3, column=1, sticky='EW', padx=5)
        Hoverbox(self.coff_16, 'Compensation Coefficient 16')
        self.coff_17 = Entry(frame, textvariable=self.var_coff_17, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_17.focus()
        self.coff_17.grid(row=3, column=2, sticky='EW')
        Hoverbox(self.coff_17, 'Compensation Coefficient 17')
        self.coff_18 = Entry(frame, textvariable=self.var_coff_18, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_18.focus()
        self.coff_18.grid(row=3, column=3, sticky='EW', padx=5)
        Hoverbox(self.coff_18, 'Compensation Coefficient 18')
        self.coff_19 = Entry(frame, textvariable=self.var_coff_19, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_19.focus()
        self.coff_19.grid(row=3, column=4, sticky='EW')
        Hoverbox(self.coff_19, 'Compensation Coefficient 19')
        self.coff_20 = Entry(frame, textvariable=self.var_coff_20, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_20.focus()
        self.coff_20.grid(row=3, column=5, sticky='EW', padx=5)
        Hoverbox(self.coff_20, 'Compensation Coefficient 20')
        self.coff_21 = Entry(frame, textvariable=self.var_coff_21, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_21.focus()
        self.coff_21.grid(row=3, column=6, sticky='EW')
        Hoverbox(self.coff_21, 'Compensation Coefficient 21')
        self.coff_22 = Entry(frame, textvariable=self.var_coff_22, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_22.focus()
        self.coff_22.grid(row=3, column=7, sticky='EW', padx=5)
        Hoverbox(self.coff_22, 'Compensation Coefficient 22')
        self.coff_23 = Entry(frame, textvariable=self.var_coff_23, width=10, validate='key', validatecommand=vcmd, state=DISABLED)
        self.coff_23.focus()
    ...
    def enable_operations(self):
        ...
        self.e_target.config(state=NORMAL)
