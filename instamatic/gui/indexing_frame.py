...
class IndexFrame(LabelFrame):
    ...
    def __init__(self, parent):
        ...
        self.e_a = Entry(frame, textvariable=self.var_a, width=6, justify='center', state=NORMAL)
        ...
        self.e_b = Entry(frame, textvariable=self.var_b, width=6, justify='center', state=NORMAL)
        ...
        self.e_c = Entry(frame, textvariable=self.var_c, width=6, justify='center', state=NORMAL)
        ...
        self.e_alpha = Entry(frame, textvariable=self.var_alpha, width=6, justify='center', state=NORMAL)
        ...
        self.e_beta = Entry(frame, textvariable=self.var_beta, width=6, justify='center', state=NORMAL)
        ...
        self.e_gamma = Entry(frame, textvariable=self.var_gamma, width=6, justify='center', state=NORMAL)
        ...
        self.e_space_group = Entry(frame, textvariable=self.var_space_group, width=6, justify='center', state=NORMAL)
        self.e_space_group.grid(row=2, column=2, sticky='EW')
        Label(frame, text='dmax').grid(row=2, column=3, columnspan=2, sticky='EW', padx=5)
        self.e_dmax = Entry(frame, textvariable=self.var_dmax, width=6, justify='center', state=NORMAL)
        ...
        self.e_dmin = Entry(frame, textvariable=self.var_dmin, width=6, justify='center', state=NORMAL)
        ...
        self.e_thickness = Entry(frame, textvariable=self.var_thickness, width=6, justify='center', state=NORMAL)
