...
ROTATION_AXIS= {rot_x:.4f} {rot_y:.4f} {rot_z:.4f}     !Cos(theta) Cos(theta+90)

! ********** Incident beam **********

 X-RAY_WAVELENGTH= {wavelength:.4f}              !used by IDXREF
 INCIDENT_BEAM_DIRECTION= 0 0 1        !The vector points from the source towards the crystal, used by IDXREF +CORRECT(?)
...
! ********** Indexing **********
 ...
 ! SEPMIN=2.0            !6.0 is default, hardly needs to be changed
 ! CLUSTER_RADIUS=2    !3 is default, hardly needs to be changed.
